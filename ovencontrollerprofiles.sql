...
--
-- Host: localhost    Database: ovencontrollerprofiles
-- ------------------------------------------------------
...
CREATE TABLE `ProfileData` (
  `soak_temp` int(11) DEFAULT NULL,
  `soak_time` int(11) DEFAULT NULL,
  `reflow_temp` int(11) DEFAULT NULL,
  `reflow_time` int(11) DEFAULT NULL
...
INSERT INTO `ProfileData` VALUES (23,34,78,78);
...
-- Dump completed on 2014-01-31 16:22:40
